function startApp() {
    ...
    const kinveyAppKey = "kid_r11QOPsMd"; //ключовете от Кинви
    const kinveyAppSecret = "5a8c8675b64b4834a0ed70e7f7f85114"; //автентикацията от кинви..
    ...
    function showHideMenuLinks() {
        $('#linkHome').show();//podobno na document.getElementByiD
    ...
    function showLoginView() {
        showView('viewLogin');
        $('#formLogin').trigger('reset');//prezarejda formta,zachistva dannite..
    }
